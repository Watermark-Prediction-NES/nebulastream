...
namespace
{
const auto FILE_PATH_PARAMETER = NES::Identifier::parse("FILE_PATH");
}
...
bool MemorySource::setup()
{
    ...
    NES_DEBUG("MemorySource: Loaded {} bytes from {}", fileSize, filePath);
...
FileDataRegistryReturnType MemorySource::provideFileData(FileDataRegistryArguments systestAdaptorArguments)
{
