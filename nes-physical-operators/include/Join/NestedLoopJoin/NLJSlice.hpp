...
public:
    ...
    [[nodiscard]] uint64_t getNumberOfLeftPagedVectors() const noexcept { return leftPagedVectorBuffers.size(); }

    [[nodiscard]] uint64_t getNumberOfRightPagedVectors() const noexcept { return rightPagedVectorBuffers.size(); }
